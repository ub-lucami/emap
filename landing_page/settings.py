...
TEMPLATES = [
    {
        ...
        "DIRS": [BASE_DIR / 'emapp/templates/emapp'],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
LANGUAGE_CODE = config('LANGUAGE_CODE', default='sl-si')  # Slovenian (Slovenia)

TIME_ZONE = config('TIME_ZONE', default='Europe/Ljubljana')
